                            ...
                            <div class="d-none d-lg-flex align-items-center mr-3">
                                ...
                                <ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
                                    ...
                                    <li class="nav-item mr-3">
                                        <a href="#" class="nav-link py-4 px-6 <?php if($pageTitle == 'user') echo 'active';?>" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">User's</a>
                                    </li>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="nav-item mr-3">
                                        <a href="#" class="nav-link py-4 px-6 <?php if($pageTitle == 'notice') echo 'active';?>" data-toggle="tab" data-target="#kt_header_tab_3" role="tab">Notice</a>
                                    </li>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="nav-item mr-3">
                            ...
                            <div class="header-navs header-navs-left" id="kt_header_navs">
                                ...
                                <ul class="header-tabs p-5 p-lg-0 d-flex d-lg-none nav nav-bold nav-tabs" role="tablist">
                                    ...
                                    <!--end::Item-->
                                     <!--begin::Item-->
                                     <li class="nav-item mr-2">
                                        <a href="#" class="nav-link btn btn-clean <?php if($pageTitle == 'notice') echo 'active';?>" data-toggle="tab" data-target="#kt_header_tab_3" role="tab">Notice</a>
                                    </li>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="nav-item mr-2">
                                        <a href="#" class="nav-link btn btn-clean <?php if($pageTitle == 'report') echo 'active';?>" data-toggle="tab" data-target="#kt_header_tab_4" role="tab">Report</a>
                                    </li>
                                    <!--end::Item-->
                                </ul>
                                <!--begin::Tab Navs-->
                                ...
                                <div class="tab-content">
                                    ...
                                    <!--begin::Tab Pane-->
                                    <div class="tab-pane p-5 p-lg-0 justify-content-between <?php if($pageTitle == 'user') echo 'active';?>" id="kt_header_tab_2">
                                    ...
                                    <!--begin::Tab Pane-->
                                    <!--begin::Tab Pane-->
                                    <div class="tab-pane p-5 p-lg-0 justify-content-between <?php if($pageTitle == 'notice') echo 'active';?>" id="kt_header_tab_3">
                                        <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center">
                                            <!--begin::Actions-->
                                            <div id="kt_header_menu_1" class="header-menu header-menu-mobile header-menu-layout-default">
                                                <!--begin::Nav-->
                                                <ul class="menu-nav">
                                                    <li class="menu-item menu-item-<?php if($pageName == 'notice') echo 'active';?>" aria-haspopup="true">
                                                        <a href="admin_notice.php" class="menu-link">
                                    ...
                                    <!--begin::Tab Pane-->
                                    <!--begin::Tab Pane-->
                                    <div class="tab-pane p-5 p-lg-0 justify-content-between <?php if($pageTitle == 'report') echo 'active';?>" id="kt_header_tab_4">
                                        <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center">
                                            <!--begin::Actions-->
...
<!--end::Body-->
<svg id="SvgjsSvg1001" width="2" height="0" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" style="overflow: hidden; top: -100%; left: -100%; position: absolute; opacity: 0;"><defs id="SvgjsDefs1002"></defs><polyline id="SvgjsPolyline1003" points="0,0"></polyline><path id="SvgjsPath1004" d="M-1 200L-1 200C-1 200 68.83333333333333 200 68.83333333333333 200C68.83333333333333 200 137.66666666666666 200 137.66666666666666 200C137.66666666666666 200 206.5 200 206.5 200C206.5 200 275.3333333333333 200 275.3333333333333 200C275.3333333333333 200 344.16666666666663 200 344.16666666666663 200C344.16666666666663 200 413 200 413 200C413 200 413 200 413 200 "></path></svg>
