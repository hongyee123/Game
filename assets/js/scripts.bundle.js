...
KTUtil.ready(function() {
    ...
    if (typeof KTLayoutHeaderMenu !== 'undefined') {
        ...
        KTLayoutHeaderMenu.init('kt_header_menu_1', 'kt_header_navs');
        KTLayoutHeaderMenu.init('kt_header_menu_2', 'kt_header_navs');
        KTLayoutHeaderMenu.init('kt_header_menu_3', 'kt_header_navs');
        KTLayoutHeaderMenu.init('kt_header_menu_4', 'kt_header_navs');
        KTLayoutHeaderMenu.init('kt_header_menu_5', 'kt_header_navs');
    }
